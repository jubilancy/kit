---
title: "API Documentation: Parse Local Documents to LLM-Ready Data"
description: Upload local documents and convert them into clean, LLM-ready data formats like Markdown, JSON, and HTML with our API's parse endpoint, powered by Rust for up to 5x faste
tags: [llm, parse, documentation, api, rust, parsing, markdown, json, llm-data-preparation, document-conversion, api-for-parsing-documents, rust-parsing-engine, zero-data-retention, markdown-conversion, json-conversion, document-parsing-api]
---
